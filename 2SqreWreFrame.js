...
function Set4SubBxs() {
    ...
    // B Square sub box A
    document.getElementById("PslySqreA").style.left = "".concat(0, "px");
    document.getElementById("PslySqreA").style.top = "".concat(0, "px");
    // B Square sub box B
    document.getElementById("PslySqreB").style.left = "".concat((Sqre / 2), "px");
    document.getElementById("PslySqreB").style.top = "".concat(0, "px");
    // B Square sub box C
    document.getElementById("PslySqreC").style.left = "".concat(0, "px");
    document.getElementById("PslySqreC").style.top = "".concat((Sqre / 2), "px");
    // B Square sub box D
    document.getElementById("PslySqreD").style.left = "".concat((Sqre / 2), "px");
    document.getElementById("PslySqreD").style.top = "".concat((Sqre / 2), "px");
}
